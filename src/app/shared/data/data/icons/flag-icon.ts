export const icon = [
    { abbrivation: 'in', name: 'India Flag' }, { abbrivation: 'ad', name: 'Andorra Flag' }, { abbrivation: 'ae', name: 'United Arab Emirates Flag' },
   ...
   { abbrivation: 'cr', name: 'Costa Rica Flag' }, { abbrivation: 'cu', name: 'Zeta Flag' }, { abbrivation: 'cv', name: 'Cabo Verde Flag' },
