...
export let Visitors: ChartOptions | any = {
  series: [
    {
      name: "Active",
...
export const FacebookChart: ChartOptions | any = radialCommonOption(radial1);
// Twitter
const radial2: socialMedia = {
  color: ["#FFA941"],
...
export const TwitterChart: ChartOptions | any = radialCommonOption(radial2);
//Instagram
...
export const InstagramChart: ChartOptions | any = radialCommonOption(radial3);
// //Youtube
...
export const YoutubeChart: ChartOptions | any = radialCommonOption(radial4);
...
/*Line chart3*/
export let chartWidget1: ChartOptions | any = {
  chart: {
    toolbar: {
      show: false,
    },
...
/*Line chart3*/
export let chartWidget2: ChartOptions | any = {
  chart: {
    toolbar: {
      show: false,
    },
...
/*Line chart3*/
export let chartWidget3: ChartOptions | any = {
  chart: {
    toolbar: {
      show: false,
    },
...
export let chartWidget4: ChartOptions | any = {
  series: [
    {
      name: "Profit",
...
export let cricleChart: ChartOptions | any = {
  chart: {
    type: "radialBar",
    height: 375,
    offsetY: -30,
...
export let liveProducts: ChartOptions | any = {
  chart: {
    height: 320,
    type: "area",
    toolbar: {
...
export let cryptoCurrencyPrices: ChartOptions | any = {
  chart: {
    toolbar: {
      show: false,
    },
...
export let cryptoAnotation: ChartOptions | any = {
  series: [
    {
...
export let stokeMarket: ChartOptions | any = {
  series: [
    {
      name: "line",
      type: "line",
  ...
  tooltip: {
    shared: true,
    custom: [
      function ({ seriesIndex, dataPointIndex, w }: ChartOptions) {
...
export let orderStatusProcesses: ChartOptions | any = {
  chart: {
    height: 350,
    type: "line",
    stacked: true,
...
export let monthySales: ChartOptions | any = {
  fill: {
    type: "gradient",
    gradient: {
      shade: "dark",
